...
@section('content')
	<main class="main">
        ...
        <div class="page-title text-center">
            <h2 class="title"> {{ $prep->name }} - Subscription </h2>
        ...
        <div class="breadcrumbs">
            <div class="container">
                ...
                <span class="child">
                    <a href="{{ route('prep.details', ['slug' => $prep->slug]) }}">
                        {{ $prep->name }}
                    </a>
                </span>
        ...
        <section class="services-hood">
            ...
            <div class="row">
                ...
                <p class="text-center f-20 text-dark">  Amount :
                   <strong>{{ number_format($prep->price) }} FCFA</strong>
                </p>
                ...
                <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                    ...
                    <input type="hidden" name="code" id="code" value="{{ $prep->code }}">
    ...
    $(document).ready(function(){
        ...
        $pay.click(function(){
            ...
            if(isValidNumber(number))
            {
                ...
                $.ajax({
                    url : '/api/subscribe/prep',
                    method : 'post',
                    data : { _token:token, code:code, user:user, number:number },
                    error : function(e)
                    {
                        console.log(e);
                        stopLoading();
