        ...
        <div class="col-md-3">
            <div class="panel panel-primary">
                ...
                <div class="panel-body text-center">
                    ...
                    @if($tut->status == "PENDING")
                    <p class="text-center">
                        <strong class="text-dark">
                            This Tutorial is awaiting Publishing
                        </strong>
                    </p>
                    ...
                    <p class="tent-center">
                        <strong class="text-dark">
                            This Tutorial is Alive <i class="fa fa-check text-success"></i>
                        </strong>
                    </p>
                    @endif
                    ...
                    <div class="row text-center">
                        @if($tut->status == "PENDING")
                        <a href="{{ route('tutor.tut.publish', ['code' => $tut->code]) }}"
                        ...
                        <a href="{{ route('tutor.tut.down', ['code' => $tut->code]) }}"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            @else
                                ...
                                @foreach($tut->content as $content)
                                    <tr class="text-black">
                                        <td> {{ $count++ }} </td>
                                        <td> {{ $content->name }} </td>
                                        <td> {{ $content->title }} </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" enctype="multipart/form-data"
                action="{{ route('tutor.tut.content.store', ['code' => $tut->code]) }}"
                method="post">
                @csrf
